...
//    YSJCellModel *cellModel00 = [YSJCellModel modelWithHeadingModel:headingModel00 centerModel:centerModel00 tailingModel:trailModel00 selectedHandle:^{
//        NSLog(@"00");
//    }];
...
//    YSJCellModel *cellModel01 = [YSJCellModel modelWithHeadingModel:headingModel01 centerModel:centerModel01 tailingModel:trailModel01 selectedHandle:^{
//        NSLog(@"01");
//    }];
...
//        YSJLog(@"%@",cellModel);
//    };
//    YSJCellModel *cellModel10 = [YSJCellModel modelWithHeadingModel:headingModel10 centerModel:centerModel10 tailingModel:trailModel10 selectedHandle:^{
//        NSLog(@"10");
//    }];
...
//    YSJCellModel *cellModel11 = [YSJCellModel modelWithHeadingModel:headingModel11 centerModel:centerModel11 tailingModel:trailModel11 selectedHandle:^{
//        NSLog(@"11");
//    }];
...
//    YSJCellModel *cellModel20 = [YSJCellModel modelWithHeadingModel:headingModel20 centerModel:centerModel20 tailingModel:trailModel20 selectedHandle:^{
//        NSLog(@"20");
//    }];
...
//    YSJCellModel *cellModel21 = [YSJCellModel modelWithHeadingModel:headingModel21 centerModel:centerModel21 tailingModel:trailModel21 selectedHandle:^{
//        NSLog(@"21");
//    }];
