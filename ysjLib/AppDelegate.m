...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    UINavigationController *nav2 = [[UINavigationController alloc]initWithRootViewController:[[ViewController2 alloc]init]];
    ...
    YSJNavigationController *nav4 = [[YSJNavigationController alloc]initWithRootViewController:[[SettingViewController alloc]init]];
    UITabBarItem *item4 = [[UITabBarItem alloc]initWithTitle:@"cell" image:nil selectedImage:nil];
...
- (NSURL *)applicationDocumentsDirectory {
    // The directory the application uses to store the Core Data store file. This code uses a directory named "com.harry.ysjLib" in the application's documents directory.
...
- (NSManagedObjectModel *)managedObjectModel {
    ...
    NSURL *modelURL = [[NSBundle mainBundle] URLForResource:@"ysjLib" withExtension:@"momd"];
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator {
    ...
    NSURL *storeURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"ysjLib.sqlite"];
    NSError *error = nil;
